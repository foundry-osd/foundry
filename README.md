...
- **Custom answer files** — [import and select an Unattend file](https://docs.foundryosd.com/foundry-osd/customization/unattend) for Windows first-run setup, accounts, and commands.
