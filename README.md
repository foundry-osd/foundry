...
Foundry is available under the [MIT License](LICENSE). Anonymous usage telemetry is enabled by default and can be disabled in Settings. See [Telemetry and privacy](https://docs.foundryosd.com/reference/telemetry-and-privacy), [Third-Party Notices](THIRD_PARTY_NOTICES.md), and the [Code of Conduct](CODE_OF_CONDUCT.md).
