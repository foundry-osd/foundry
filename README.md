...
- **Custom answer files** — [import and select an Unattend file](https://github.com/foundry-osd/GitBook/blob/b217dce9373ce1347948581802e4aec88a7824b3/foundry-osd/customization/unattend.md) for Windows first-run setup, accounts, and commands.
