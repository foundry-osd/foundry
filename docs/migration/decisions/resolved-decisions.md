...
- [x] **RD-016: WinPE runtime secret protection**
  ...
  - The default embedded secret format is `aes-gcm-v1` with a random per-media 256-bit key, a random 96-bit nonce, a 128-bit authentication tag, and ciphertext.
