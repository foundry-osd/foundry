...
public sealed class DeploymentUiTextLocalizerTests : IDisposable
{
    ...
    [InlineData("Windows Autopilot device group tag update was not confirmed before the timeout.", "La mise à jour du group tag de l’appareil Windows Autopilot n’a pas été confirmée avant le timeout.")]
    ...
    [InlineData("Checking Windows Autopilot group tag (600 seconds remaining)...", "Vérification du group tag Windows Autopilot (600s)...")]
