...
public sealed class CustomImageSelectionTests
{
    ...
    public void Selection_PreservesUnknownMetadataAndExactIndexWithoutCatalogDefaults()
    {
        ...
        var selection = new CustomImageSelection(new CustomImageAsset { Id = "manual", DisplayName = "Image", ImagePath = @"D:\Foundry\Images\Custom\image.wim", VolumeRoot = @"D:\" }, index);
