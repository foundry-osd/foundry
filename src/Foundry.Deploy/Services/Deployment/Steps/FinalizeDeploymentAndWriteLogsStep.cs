...
public sealed class FinalizeDeploymentAndWriteLogsStep : DeploymentStepBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        string json = JsonSerializer.Serialize(new
        {
            ...
            imagePreflightLevel = runtimeState.ImagePreflight?.Level.ToString(),
            imagePreflightRequiredTargetBytes = runtimeState.ImagePreflight?.RequiredTargetBytes,
            imagePreflightConstraint = runtimeState.ImagePreflight?.ConstraintReason,
