    ...
    private static string BuildOobeWaiter()
    {
        return string.Join(
            ...
            [
                ...
                "$serviceUiTargetProcessNames = @('CloudExperienceHost', 'CloudExperienceHostBroker', 'UserOOBEBroker', 'oobenetworkconnectionflow', 'ApplicationFrameHost', 'ShellExperienceHost', 'RuntimeBroker', 'powershell', 'cmd')",
                ...
                "        }",
                "        $processNames = $serviceUiTargetProcessNames + @('pwsh')",
