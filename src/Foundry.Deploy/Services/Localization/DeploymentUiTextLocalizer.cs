...
public static partial class DeploymentUiTextLocalizer
{
    ...
    public static string LocalizeStepName(string value)
    {
        return value switch
        {
            ...
            "Provision OS Recovery" => LocalizationText.GetString("Step.ProvisionOsRecovery"),
    ...
    public static string LocalizeMessage(string value)
    {
        ...
        return value switch
        {
            ...
            "OS Recovery is disabled." => LocalizationText.GetString("StepResult.OsRecoveryDisabled"),
            "OS Recovery provisioning is skipped in recovery mode." => LocalizationText.GetString("StepResult.OsRecoverySkippedInRecoveryMode"),
            "Provisioning OS Recovery..." => LocalizationText.GetString("StepMessage.ProvisioningOsRecovery"),
            "Injecting OS Recovery payload..." => LocalizationText.GetString("StepMessage.InjectingOsRecoveryPayload"),
            "Committing WinRE changes..." => LocalizationText.GetString("StepMessage.CommittingWinReChanges"),
            "Registering OS Recovery boot menu..." => LocalizationText.GetString("StepMessage.RegisteringOsRecoveryBootMenu"),
            "OS Recovery provisioned." => LocalizationText.GetString("StepResult.OsRecoveryProvisioned"),
            "OS Recovery provisioned (simulation)." => LocalizationText.GetString("StepResult.OsRecoveryProvisionedSimulation"),
