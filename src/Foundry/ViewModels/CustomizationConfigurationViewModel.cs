...
public sealed partial class CustomizationConfigurationViewModel : ObservableObject, IDisposable
{
    ...
    private void RefreshLocalizedText()
    {
        ...
        // The intro is localized; the variable examples are literal tokens listed one per line beneath it.
        MachineNamingPrefixDescription = string.Join(
            Environment.NewLine,
            new[] { localizationService.GetString("Customization.MachineNamingPrefixDescription") }
                .Concat(ComputerNameTemplate.SupportedVariables.Select(variable => "${" + variable + "}")));
