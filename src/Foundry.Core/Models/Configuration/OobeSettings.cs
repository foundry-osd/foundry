...
/// <summary>
/// Describes Windows first-run screens and privacy defaults applied before OOBE starts.
/// </summary>
public sealed record OobeSettings
{
    /// <summary>
    /// Gets whether Foundry should write OOBE customization settings to the deployed Windows installation.
    /// </summary>
    ...
    /// </summary>
    public OobeDiagnosticDataLevel DiagnosticDataLevel { get; init; } = OobeDiagnosticDataLevel.Required;
