...
if ([string]::IsNullOrWhiteSpace($ReleaseNotesPath)) {
    Set-Content -Path $generatedReleaseNotesPath -Value "# Foundry $PackVersion`n`nRelease notes are generated by GitHub Releases during the release workflow." -NoNewline
}
